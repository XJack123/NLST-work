...
def main():
    ...
    # Use utf-8-sig to tolerate possible BOM written by external tools on Windows
    with open(args.environment_file, "r", encoding="utf-8-sig") as f_env:
        env_dict = json.load(f_env)
    with open(args.config_file, "r", encoding="utf-8-sig") as f_cfg:
        config_dict = json.load(f_cfg)
